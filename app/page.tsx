...
import BoardScreen from "@/components/home/BoardScreen";

const PageHeading = () => (
  <header className="z-10 w-full max-w-xl px-5 xl:px-0">
    <a
...
const Features = () => (
  <section className="my-10 grid w-full max-w-screen-xl animate-fade-up grid-cols-1 gap-5 px-5 md:grid-cols-3 xl:px-0">
